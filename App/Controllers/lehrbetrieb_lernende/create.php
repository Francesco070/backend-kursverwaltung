...
$errors = [];
if (empty($fk_lehrbetrieb)) $errors['fk_lehrbetrieb'] = 'fk_lehrbetrieb is required.';
if (empty($fk_lernende)) $errors['fk_lernende'] = 'fk_lernende is required.';
if (empty($start)) $errors['start'] = 'starte is required.';
if (empty($ende)) $errors['ende'] = 'ende is required.';
...
$query = 'INSERT INTO tbl_lehrbetrieb_lernende (fk_lehrbetrieb, fk_lernende, start, ende) VALUES (:fk_lehrbetrieb, :fk_lernende, :start, :ende)';
...
try {
    ...
    Response::json([
        'status' => 'error',
        'message' => 'An error occurred while creating the Lehrbetrieb_Lernende',
