...
if (isset($params['id']) && ctype_digit($params['id'])) {
    ...
    try {
        // Prepare the query to delete the kurs_lernende by id
        ...
        if ($stmt->rowCount() > 0) {
            ...
            Response::json([
                'status' => 'success',
                'message' => 'Kurs-Lernende record deleted successfully!'
            ], Response::OK);
        } else {
        ...
        Response::json([
            'status' => 'error',
            'message' => 'An error occurred while deleting the Kurs-Lernende record',
