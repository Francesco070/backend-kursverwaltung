...
if (isset($params['id']) && ctype_digit($params['id'])) {
    ...
    try {
        ...
        if (isset($input['fk_kurs'])) {
            ...
            $params[':fk_kurs'] = (int) $input['fk_kurs'];
        }
        if (isset($input['role'])) {
        ...
        Response::json([
            'status' => 'success',
            'message' => 'Kurs-Lernende relationship updated successfully!'
        ], Response::OK);
        ...
        Response::json([
            'status' => 'error',
            'message' => 'An error occurred while updating the kurs_lernende relationship'
